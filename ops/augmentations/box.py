...
import math
from ops.augmentations import vector
...
class Box(object):
    ...
    def __init__(self, v1_or_box, v2=None):
        ...
        if v2 == None:
            ...
            self.set_coords(vector.Vec3d(v1_or_box), vector.Vec3d(v2))

    def set_coords(self, v1, v2):
        """Reset the box coordinates."""
        self._min  = vector.minimum(v1, v2)
        self._max  = vector.maximum(v1, v2)
        self._size = self._max - self._min

    def size(self):
        return vector.Vec3d(self._size)
    ...
    def intersect(self, other):
        ...
        if self.overlaps(other):
            ...
            vmax = vector.minimum(self._max, other._max)
    ...
    def merge(self, other):
        ...
        """
        # min/max corners
        vmin = vector.minimum(self._min, other._min)
        vmax = vector.maximum(self._max, other._max)
    ...
    def min(self):
        ...
        return vector.Vec3d(self._min)

    def max(self):
        """Return the max corner as a vector."""
        return vector.Vec3d(self._max)
...
if __name__ == "__main__":
    ...
    class UnitTestBox(unittest.TestCase):
        ...
        def testCreationAndAccess(self):
            b = Box((1,1,1),[2,2,2])
            self.assertTrue(b.min()  == vector.Vec3d(1,1,1))
            self.assertTrue(b.max()  == vector.Vec3d(2,2,2))
            self.assertTrue(b.size() == vector.Vec3d(1,1,1))
            b = Box((1,0,1),[0,1,0])
            self.assertTrue(b.min()  == vector.Vec3d(0,0,0))
            self.assertTrue(b.max()  == vector.Vec3d(1,1,1))
            self.assertTrue(b.size() == vector.Vec3d(1,1,1))
            b1 = Box(b)
            self.assertTrue(b1.min()  == vector.Vec3d(0,0,0))
            self.assertTrue(b1.max()  == vector.Vec3d(1,1,1))
            self.assertTrue(b1.size() == vector.Vec3d(1,1,1))
        ...
        def testContains(self):
            b = Box(vector.Vec3d(1,1,1),[3,3,3])
        ...
        def testOverlaps(self):
            b1 = Box(vector.Vec3d(1,1,1),[2,2,2])
            b2 = Box(vector.Vec3d(3,3,3),[2,2,2])
        ...
        def testExpand(self):
            b1 = Box(vectorVec3d(1,1,1),[2,2,2])
            b1.expand_by(1)
