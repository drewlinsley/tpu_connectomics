...
from box import Box
from ops.augmentations import vector, box, aug_utils
from ops.augmentations.warping import warping
import numpy as np
...
if __name__ == "__main__":
    ...
    # In/out size.
    outsz = vector.Vec3d(5,100,100)
    for k, v in spec.iteritems():
        newv = tuple(vector.Vec3d(v[-3:]) + outsz - vector.Vec3d(1,1,1))
        spec[k] = v[:-3] + newv
